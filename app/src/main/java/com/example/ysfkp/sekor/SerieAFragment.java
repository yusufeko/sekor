...
public class SerieAFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_serie_a, container, false);

        RecyclerView recyclerView = (RecyclerView) v.findViewById(R.id.recSerieA);
    ...
    class LoadMatchTask extends AsyncTask<Void, Void, List<MatchResult>> {
        ...
        protected List<MatchResult> doInBackground(Void... params) {
            ...
            Match match = new Match("2017-05-12T12:00:00-03:00&to=2017-05-19T12:00:00-03:00", "49");
